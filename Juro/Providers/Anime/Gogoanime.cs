...
namespace Juro.Providers.Anime
{
    ...
    public class Gogoanime : IAnimeProvider
    {
            ...
            for (var i = 0; i < animeInfoNodes.Count; i++)
            {
                switch (i)
                {
                    ...
                    case 6: //Other Name
                        ...
                        anime.OtherNames = new Regex("[ ]{2,}", RegexOptions.None).Replace(anime.OtherNames, " ")
                            .Trim();
                        break;
                    default:
                        break;
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var animeId = document.DocumentNode.Descendants().FirstOrDefault(x => x.Id == "movie_id")
        ...
        {
            return string.Join("", text.Take(2)) == "//" ? $"https:{text}" : text;
        }
