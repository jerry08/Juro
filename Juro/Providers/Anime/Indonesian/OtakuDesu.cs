...
namespace Juro.Providers.Anime.Indonesian
{
    public class OtakuDesu : IAnimeProvider
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            for (var i = 0; i < nodes?.Count; i++)
            {
                ...
                if (genresNode is not null)
                {
                    ...
                    anime.Genres = genres?.Select(x => new Genre(x.Trim())).ToList() ?? new List<Genre>();
                }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            animeInfo.Title = string.Concat(document.DocumentNode
                .SelectSingleNode(".//div[@class='infozin']//p[1]/span")
            ...
            animeInfo.Status = string.Concat(document.DocumentNode
                .SelectSingleNode(".//div[@class='infozin']//p[6]/span")
                ?.LastChild?.InnerText?.Split(':').Skip(1) ?? Array.Empty<string>()).Trim();

            animeInfo.Studio = string.Concat(document.DocumentNode
                .SelectSingleNode(".//div[@class='infozin']//p[10]/span")
                ?.LastChild?.InnerText?.Split(':').Skip(1) ?? Array.Empty<string>()).Trim();

            animeInfo.Genres = string.Concat(document.DocumentNode
                    .SelectSingleNode(".//div[@class='infozin']//p[11]/span")
        ...
        {
            new Genre("Action", $"{BaseUrl}/genres/action"),
            new Genre("Adventure", $"{BaseUrl}/genres/adventure"),
            new Genre("Comedy", $"{BaseUrl}/genres/comedy"),
            new Genre("Demons", $"{BaseUrl}/genres/demons"),
            new Genre("Drama", $"{BaseUrl}/genres/drama"),
            new Genre("Ecchi", $"{BaseUrl}/genres/ecchi"),
            new Genre("Fantasy", $"{BaseUrl}/genres/fantasy"),
            new Genre("Game", $"{BaseUrl}/genres/game"),
            new Genre("Harem", $"{BaseUrl}/genres/harem"),
            new Genre("Historical", $"{BaseUrl}/genres/historical"),
            new Genre("Horror", $"{BaseUrl}/genres/horror"),
            new Genre("Josei", $"{BaseUrl}/genres/josei"),
            new Genre("Magic", $"{BaseUrl}/genres/magic"),
            new Genre("Martial Arts", $"{BaseUrl}/genres/martial-arts"),
            new Genre("Mecha", $"{BaseUrl}/genres/mecha"),
            new Genre("Military", $"{BaseUrl}/genres/military"),
            new Genre("Music", $"{BaseUrl}/genres/music"),
            new Genre("Mystery", $"{BaseUrl}/genres/mystery"),
            new Genre("Psychological", $"{BaseUrl}/genres/psychological"),
            new Genre("Parody", $"{BaseUrl}/genres/parody"),
            new Genre("Police", $"{BaseUrl}/genres/police"),
            new Genre("Romance", $"{BaseUrl}/genres/romance"),
            new Genre("Samurai", $"{BaseUrl}/genres/samurai"),
            new Genre("School", $"{BaseUrl}/genres/school"),
            new Genre("Sci-Fi", $"{BaseUrl}/genres/sci-fi"),
            new Genre("Seinen", $"{BaseUrl}/genres/seinen"),
            new Genre("Shoujo", $"{BaseUrl}/genres/shoujo"),
            new Genre("Shoujo Ai", $"{BaseUrl}/genres/shoujo-ai"),
            new Genre("Shounen", $"{BaseUrl}/genres/shounen"),
            new Genre("Slice of Life", $"{BaseUrl}/genres/slice-of-life"),
            new Genre("Sports", $"{BaseUrl}/genres/sports"),
            new Genre("Space", $"{BaseUrl}/genres/space"),
            new Genre("Super Power", $"{BaseUrl}/genres/super-power"),
            new Genre("Supernatural", $"{BaseUrl}/genres/supernatural"),
            new Genre("Thriller", $"{BaseUrl}/genres/thriller"),
            new Genre("Vampire", $"{BaseUrl}/genres/vampire")
        };
    }
}