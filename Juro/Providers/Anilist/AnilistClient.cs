...
namespace Juro.Providers.Anilist
{
    ...
    public class AnilistClient
    {
        ...
        public AnilistClient(Func<HttpClient> httpClientProvider)
        {
            ...
            Aniskip = new AniskipClient(httpClientProvider);
        }
            ...
            string variables = "")
        {
            ...
            {
                throw new Exception(
                    "Seems like Anilist is down, maybe try using a VPN or you can wait for it to comeback.");
            }
        ...
        public async ValueTask<Media?> GetMediaDetailsAsync(Media media)
        {
            ...
            if (response is not null)
            {
                ...
                {
                    media.Relations = new List<Media>();
                ...
                {
                    media.Recommendations = new List<Media>();
