...
namespace Juro.Providers.Anilist.Api
{
    ...
    {
        [JsonPropertyName("edges")] public List<CharacterEdge>? Edges { get; set; }

        [JsonPropertyName("nodes")] public List<Character>? Nodes { get; set; }
    }

    public class CharacterEdge
    {
        [JsonPropertyName("node")] public Character? Node { get; set; }
