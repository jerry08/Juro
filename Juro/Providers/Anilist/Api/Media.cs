...
namespace Juro.Providers.Anilist.Api
{
    ...
    {
        [JsonPropertyName("tags")] public List<MediaTag>? Tags { get; set; }
    }
    ...
    {
        [JsonPropertyName("edges")] public List<MediaEdge>? Edges { get; set; }

        [JsonPropertyName("nodes")] public List<Media>? Nodes { get; set; }
